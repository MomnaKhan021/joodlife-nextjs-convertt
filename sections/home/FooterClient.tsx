...
const DEFAULT_JOOD_LINKS: FooterLink[] = [
...
export default function Footer(props: FooterProps = {}) {
  ...
  const contactHeading = props.contactHeading || "Have a question?";
  const phone = props.phone || "07756 099075";
  const contactEmail = props.email || "support@joodlife.com";
