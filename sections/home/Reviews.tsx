...
export default function Reviews() {
  const showPagination = REVIEWS.length >= PAGINATION_MIN;
        ...
        >
          ...
          >
            ...
            <Image
              ...
              alt={`Rated ${TRUSTPILOT.score} out of 5 stars`}
              width={86}
              height={16}
          ...
          <p className="max-w-[780px] font-ui text-[15px] font-semibold leading-[22px] text-[#142e2a] md:text-[16.3px] md:leading-[20px]">
            Real reviews from real patients on Trustpilot. Our patients value
            the expert support, clear communication and fast, discreet delivery
            that make every journey unique.
          </p>
        </Reveal>
