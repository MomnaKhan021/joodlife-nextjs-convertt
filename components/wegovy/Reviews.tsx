 ...
 *
 * There is no Trustpilot API integration in this project, so we cannot fetch
 * live individual reviews. To avoid displaying fabricated testimonials, this
 * section shows a genuine Trustpilot summary (logo + star rating) and links
 * out to the real Trustpilot profile where visitors can read verified reviews.
 * Mirrors sections/home/Reviews.tsx.
 */
